    ...
    <main className="min-h-screen bg-[#0a0a0a] text-white">
      ...
      <nav className="flex items-center justify-between px-6 py-5 border-b border-white/10 relative">
        ...
        {menuOpen && (
          <div className="absolute top-full left-0 right-0 bg-[#111] border-b border-white/10 flex flex-col px-6 py-4 gap-4 md:hidden z-50">
            ...
            <Link href="/register" onClick={() => setMenuOpen(false)} className="text-sm bg-violet-600 px-4 py-2 rounded-lg transition text-center">Get Started</Link>
          </div>
        )}
      </nav>
      ...
      <div className="max-w-3xl mx-auto px-4 md:px-6 py-10 md:py-16">
        ...
        <div className="mb-10 md:mb-16">
          <h1 className="text-3xl md:text-4xl font-extrabold mb-4">About AssignMate</h1>
        ...
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-8 mb-6">
          <h2 className="text-xl md:text-2xl font-bold mb-4">The Story</h2>
          <div className="flex flex-col gap-4 text-white/60 leading-relaxed text-sm md:text-base">
            <p>
        ...
        {/* Values */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-8 mb-6">
          <h2 className="text-xl md:text-2xl font-bold mb-6">What We Stand For</h2>
        ...
        {/* Builder */}
        <div className="bg-white/5 border border-white/10 rounded-2xl p-5 md:p-8 mb-6">
          <h2 className="text-xl md:text-2xl font-bold mb-6">The Builder</h2>
          <div className="flex items-center gap-4">
            <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-violet-600 flex items-center justify-center text-2xl font-bold shrink-0">
              S
            </div>
            <div className="min-w-0">
              <p className="font-semibold text-lg">Saif</p>
              <p className="text-white/40 text-xs md:text-sm">CS Student · Full Stack Developer · Teacher at WebCraft Academy</p>
              <p className="text-white/40 text-xs md:text-sm">Shaheed Benazir Bhutto University, Pakistan</p>
            </div>
          </div>
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 mt-6">
            <a href="mailto:safeysafo@gmail.com" className="text-sm text-violet-400 hover:underline">
              📧 safeysafo@gmail.com
            </a>
            <a href="https://wa.me/923092583515" target="_blank" rel="noreferrer" className="text-sm text-violet-400 hover:underline">
              💬 WhatsApp
            </a>
          </div>
        </div>
